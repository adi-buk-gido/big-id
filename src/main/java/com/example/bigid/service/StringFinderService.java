...
public class StringFinderService {
    ...
    private final Logger logger = LoggerFactory.getLogger(StringFinderService.class);

    FileReaderService fileReaderService;
    AggregatorService aggregatorService;
    MatcherService matcherService;

    public StringFinderService() {
        this.matcherService = new MatcherService();
        this.fileReaderService = new FileReaderService(matcherService);
        this.aggregatorService = new AggregatorService(matcherService);
    }

    // New constructor for tests:
    public StringFinderService(FileReaderService fileReaderService, AggregatorService aggregatorService) {
        this.fileReaderService = fileReaderService;
        this.aggregatorService = aggregatorService;
    }

    /**
     * Finding target words in a URL. We call a file reader then match the results
     * and then aggregate the response.
     * 
